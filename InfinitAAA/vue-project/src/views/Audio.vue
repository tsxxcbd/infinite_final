  ...
  export default {
    name: "index",
    components: { VideoPause, VideoPlay, lkSelect },
    props: {
      audioSrc: {
        type: String,
      ...
      <div class="card">
        ...
        <div class="option">
          <span class="pre" @click="handleBack">
            <img src="@/assets/img/快退.png" alt=""> <span
          ...
          <span class="next" @click="handleForward">
            ...
            <img src="@/assets/img/快进.png" alt="">
          </span>
          <div class="volumePanel">
            <lk-select v-model:visible="volumeVisible">
              <template v-slot:reference>
                <img class="volume" v-if="volume > 0" src="@/assets/img/24gf-volumeHigh.png" alt="">
                <img class="volume" v-else src="@/assets/img/24gf-volumeCross.png" alt="">
              </template>
