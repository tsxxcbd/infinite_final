...
public class SearchController {
    ...
    public String searchListByProfile(@RequestBody PlayList playList)throws Exception {
    ...
    public String searchListByName(@RequestBody PlayList playList)throws Exception {
